...
- Token file: `/Users/jameso/DevWork/vanyshr-stack/vanyshr-design-bible/packages/ui/src/styles/tokens.css`
...
**Mapped values:** `--background`, `--surface`, `--surface-elevated`, `--border`, `--text`, `--text-muted`, `--brand`, `--brand-primary`, `--brand-secondary`, `--brand-hover`, `--warning`, `--success`, `--destructive`, `--on-control-contrast`, `--background-brand`

Token file: `/Users/jameso/DevWork/vanyshr-stack/vanyshr-design-bible/packages/ui/src/styles/tokens.css`. Catalog: `docs/COMPONENTS.md`.
...
:root {
  ...
  --brand: rgb(20 171 254);
  --brand-primary: rgb(20 171 254);
  --brand-secondary: rgb(11 143 217);
  --brand-hover: rgb(11 143 217);
  --warning: rgb(255 94 31);
  --success: rgb(61 220 151);
  --destructive: rgb(229 72 77);
  --on-control-contrast: rgb(26 26 26);
  --background-brand: rgb(10 22 40);
}
...
|---|---|---|---|
| Brand Primary | `--brand-primary` | rgb(20 171 254) | rgb(20 171 254) |
| Brand Secondary | `--brand-secondary` | rgb(11 143 217) | rgb(11 143 217) |
| Background | `--background` | rgb(30 30 30) | rgb(30 30 30) |
| Background Brand | `--background-brand` | rgb(10 22 40) | rgb(10 22 40) |
| Surface | `--surface` | rgb(40 40 40) | rgb(40 40 40) |
| Surface Elevated | `--surface-elevated` | rgb(51 51 51) | rgb(51 51 51) |
